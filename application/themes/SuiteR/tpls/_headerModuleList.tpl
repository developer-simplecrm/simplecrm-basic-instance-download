...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header" >
            ...
            <a class="navbar-brand simple-logo" href="index.php?module=Home&action=index">{*{$APP.LBL_BROWSER_TITLE}*}
            <img src="themes/SuiteR/images/imgpsh_fullsize35.png" title="{$APP.LBL_BROWSER_TITLE}" class="img-responsive"/>
            </a>
