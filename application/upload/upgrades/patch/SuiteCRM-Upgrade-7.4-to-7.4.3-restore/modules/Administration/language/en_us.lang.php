...
$mod_strings = array (
    ...
    'LBL_MANUAL_VALIDATION4'=>'Step 3:  Transfer the validation key file (sugarvalidationkey.lic) back to the SimpleCRM system.  Import the validation key using this form below: ',
    ...
    'LBL_MASSAGE_MASS_EMAIL_DESC'=>'SimpleCRM 3.5.1+ requires an update to the Mass Email data.  Click "Begin Update" to continue.',
...
//END SUGARCRM flav=een
    ...
    'LBL_SEND_STAT'=>'<B>Send Anonymous Usage Statistics</B> - If checked, Sugar will send anonymous statistics about your installation to SimpleCRM. every time your system checks for new versions.  This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_SUGAR_NETWORK_DESC' => 'Connect to the various SimpleCRM services where you can access the SimpleCRM forums and Sugar Wiki, search FAQs (Frequently Asked Questions), download the latest Sugar version, file and research reported bugs and request new features and more.',
