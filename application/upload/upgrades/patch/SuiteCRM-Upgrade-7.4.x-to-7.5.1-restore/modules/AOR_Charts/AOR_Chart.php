...
EOF;
    ...
    private function getBarChartData($reportData, $xName,$yName){
        ...
        $data['labels'] = array();
        //~ $Data=$GLOBALS['app_list_strings']['cases_status_dom'][$data];
      
        $datasetData = array();
        foreach($reportData as $row){
			//~ print_r($reportData);
			if($GLOBALS['app_list_strings']['case_status_dom'][$row[$xName]]!=''){
				$data['labels'][]= $GLOBALS['app_list_strings']['case_status_dom'][$row[$xName]];
				
				}
				else if($GLOBALS['app_list_strings']['case_priority_dom'][$row[$xName]]!=''){
				
					$data['labels'][]= $GLOBALS['app_list_strings']['case_priority_dom'][$row[$xName]];
				}
				else if($GLOBALS['app_list_strings']['case_type_dom'][$row[$xName]]!='')
				{
					$data['labels'][]= $GLOBALS['app_list_strings']['case_type_dom'][$row[$xName]];
				}
				else
				{
    ...
    private function getPieChartData($reportData, $xName,$yName){
        ...
        foreach($reportData as $row){
			if($GLOBALS['app_list_strings']['case_status_dom'][$row[$xName]]!=''){
				$Data= $GLOBALS['app_list_strings']['case_status_dom'][$row[$xName]];
				
				}
				else if($GLOBALS['app_list_strings']['case_priority_dom'][$row[$xName]]!=''){
				
					$Data= $GLOBALS['app_list_strings']['case_priority_dom'][$row[$xName]];
				}
				else if($GLOBALS['app_list_strings']['case_type_dom'][$row[$xName]]!='')
				{
					$Data= $GLOBALS['app_list_strings']['case_type_dom'][$row[$xName]];
				}
				else
				{
						$Data= $row[$xName];
