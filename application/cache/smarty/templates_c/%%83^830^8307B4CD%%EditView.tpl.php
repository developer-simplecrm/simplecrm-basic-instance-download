...
");
    el.addEventListener("change", function(){literal}{updateDynamicEnum({/literal}"<?php echo $this->_tpl_vars['vardef']['parentenum']; ?>
","<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>"{literal})}{/literal}, false);
    window.onload = function(){literal}{updateDynamicEnum({/literal}"<?php echo $this->_tpl_vars['vardef']['parentenum']; ?>
","<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>"{literal})}{/literal}
    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded) {literal}{updateDynamicEnum({/literal}"<?php echo $this->_tpl_vars['vardef']['parentenum']; ?>
","<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>"{literal})}{/literal}
</script>