...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/DetailView/DetailView.tpl', 204, false),array('function', 'sugar_evalcolumn', 'include/DetailView/DetailView.tpl', 311, false),array('function', 'sugar_field', 'include/DetailView/DetailView.tpl', 316, false),array('modifier', 'upper', 'include/DetailView/DetailView.tpl', 211, false),array('modifier', 'count', 'include/DetailView/DetailView.tpl', 255, false),)), $this); ?>
{*
/*********************************************************************************
...
<?php if ($this->_tpl_vars['module'] == 'Accounts' || $this->_tpl_vars['module'] == 'Contacts' || $this->_tpl_vars['module'] == 'Opportunities' || $this->_tpl_vars['module'] == 'Leads' || $this->_tpl_vars['module'] == 'Cases' || $this->_tpl_vars['module'] == 'Prospects'): ?>
	<div class="row">
...
<div <?php if ($this->_tpl_vars['module'] == 'Employees'): ?>class="col-sm-12"<?php else: ?>class="row" style="border:1px solid #d9dada; margin-top:5px"<?php endif; ?> >
