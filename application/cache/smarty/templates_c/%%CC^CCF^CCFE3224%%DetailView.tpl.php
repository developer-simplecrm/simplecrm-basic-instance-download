<?php /* Smarty version 2.6.11, created on 2017-09-13 16:03:47
         compiled from cache/modules/Users/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Users/DetailView.tpl', 31, false),array('function', 'counter', 'cache/modules/Users/DetailView.tpl', 36, false),array('function', 'sugar_getimagepath', 'cache/modules/Users/DetailView.tpl', 39, false),array('function', 'sugar_translate', 'cache/modules/Users/DetailView.tpl', 42, false),array('function', 'sugar_getimage', 'cache/modules/Users/DetailView.tpl', 70, false),array('function', 'sugar_phone', 'cache/modules/Users/DetailView.tpl', 340, false),array('modifier', 'strip_semicolon', 'cache/modules/Users/DetailView.tpl', 56, false),array('modifier', 'escape', 'cache/modules/Users/DetailView.tpl', 700, false),array('modifier', 'url2html', 'cache/modules/Users/DetailView.tpl', 700, false),array('modifier', 'nl2br', 'cache/modules/Users/DetailView.tpl', 700, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Users'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
')) SUGAR.ajaxUI.submitForm(_form);" type="submit" name="Delete" value="<?php echo $this->_tpl_vars['APP']['LBL_DELETE_BUTTON_LABEL']; ?>
" id="delete_button"><?php endif; ?> </li><li><input type="submit" class="button" name="create" id="create" value="Create User" onClick="document.location='index.php?module=Users&action=EditView&return_module=Users&return_action=DetailView'"/></li><li><?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<td class="inlineEdit" type="user_name" field="user_name" width='%'  >
...
<td class="inlineEdit" type="name" field="first_name" width='%'  >
...
<td class="inlineEdit" type="enum" field="status" width='%'  >
...
<td class="inlineEdit" type="name" field="last_name" width='%'  >
...
<td class="inlineEdit" type="enum" field="UserType" width='%' colspan='3' >
...
<td class="inlineEdit" type="" field="" width='%' colspan='3' >
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DETAILVIEW_PANEL2','module' => 'Users'), $this);?>
...
<td class="inlineEdit" type="varchar" field="download_source_code_c" width='%' colspan='3' >
...
<td class="inlineEdit" type="varchar" field="employee_status" width='%'  >
...
<td class="inlineEdit" type="bool" field="show_on_employees" width='%'  >
...
<td class="inlineEdit" type="varchar" field="title" width='%'  >
...
<td class="inlineEdit" type="phone" field="phone_work" width='%'  class="phone">
...
<td class="inlineEdit" type="varchar" field="department" width='%'  >
...
<td class="inlineEdit" type="phone" field="phone_mobile" width='%'  class="phone">
...
<td class="inlineEdit" type="relate" field="reports_to_name" width='%'  >
...
<td class="inlineEdit" type="phone" field="phone_other" width='%'  class="phone">
...
<td class="inlineEdit" type="" field="" width='%'  >
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td class="inlineEdit" type="phone" field="phone_fax" width='%'  class="phone">
...
<td class="inlineEdit" type="phone" field="phone_home" width='%'  class="phone">
...
<td class="inlineEdit" type="enum" field="messenger_type" width='%'  >
...
<td class="inlineEdit" type="varchar" field="messenger_id" width='%'  >
...
<td class="inlineEdit" type="varchar" field="address_street" width='%'  >
...
<td class="inlineEdit" type="varchar" field="address_city" width='%'  >
...
<td class="inlineEdit" type="varchar" field="address_state" width='%'  >
...
<td class="inlineEdit" type="varchar" field="address_postalcode" width='%'  >
...
<td class="inlineEdit" type="varchar" field="address_country" width='%' colspan='3' >
...
<td class="inlineEdit" type="text" field="description" width='%' colspan='3' >
