...
<?php ob_start(); ?>
<tr>
<td valign="top" id='actual_date_closed_c_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='date_lost_c_label' width='12.5%' scope="col">
...
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['date_lost_c']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['date_lost_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['date_lost_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['date_lost_c']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>

</span>
<script type="text/javascript">
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['date_lost_c']['name']; ?>
",
form : "EditView",
ifFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
daFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
button : "<?php echo $this->_tpl_vars['fields']['date_lost_c']['name']; ?>
_trigger",
singleClick : true,
dateStr : "<?php echo $this->_tpl_vars['date_value']; ?>
",
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='reason_for_lost_c_label' width='12.5%' scope="col">
...
<?php if (empty ( $this->_tpl_vars['fields']['reason_for_lost_c']['value'] )):  $this->assign('value', $this->_tpl_vars['fields']['reason_for_lost_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['reason_for_lost_c']['value']);  endif; ?>  
<textarea  id='<?php echo $this->_tpl_vars['fields']['reason_for_lost_c']['name']; ?>
' name='<?php echo $this->_tpl_vars['fields']['reason_for_lost_c']['name']; ?>
'
rows="4" 
cols="60" 
title='' tabindex="0" 
...
addToValidate(\'EditView\', \'twitter_handle_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TWITTER_HANDLE','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'actual_date_closed_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACTUAL_DATE_CLOSED','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_lost_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_LOST_C','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'jjwg_maps_address_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_ADDRESS','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'reason_for_lost_c\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REASON_FOR_LOST','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'jjwg_maps_lng_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LNG','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'tweet_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TWEET_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'jjwg_maps_lat_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LAT','module' => 'Opportunities','for_js' => true), $this); echo '\' );
