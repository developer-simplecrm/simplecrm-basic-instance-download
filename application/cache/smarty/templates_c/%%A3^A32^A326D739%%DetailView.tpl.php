<?php /* Smarty version 2.6.11, created on 2017-09-13 16:59:54
         compiled from cache/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Contacts/DetailView.tpl', 125, false),array('function', 'counter', 'cache/modules/Contacts/DetailView.tpl', 135, false),array('function', 'sugar_translate', 'cache/modules/Contacts/DetailView.tpl', 156, false),array('function', 'sugar_phone', 'cache/modules/Contacts/DetailView.tpl', 165, false),array('function', 'sugar_getimage', 'cache/modules/Contacts/DetailView.tpl', 378, false),array('function', 'sugar_ajax_url', 'cache/modules/Contacts/DetailView.tpl', 522, false),array('function', 'sugar_getjspath', 'cache/modules/Contacts/DetailView.tpl', 924, false),array('modifier', 'strip_semicolon', 'cache/modules/Contacts/DetailView.tpl', 157, false),array('modifier', 'escape', 'cache/modules/Contacts/DetailView.tpl', 618, false),array('modifier', 'url2html', 'cache/modules/Contacts/DetailView.tpl', 618, false),array('modifier', 'nl2br', 'cache/modules/Contacts/DetailView.tpl', 618, false),array('modifier', 'strip_tags', 'cache/modules/Contacts/DetailView.tpl', 624, false),)), $this); ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['twitter_handle_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TWITTER_HANDLE','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="varchar" field="twitter_handle_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['twitter_handle_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['twitter_handle_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['twitter_handle_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['twitter_handle_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['twitter_handle_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['twitter_handle_c']['value']; ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
...
<div class="inlineEdit" type="enum" field="lead_source"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['user_name_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_NAME','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="varchar" field="user_name_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['user_name_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['user_name_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['user_name_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['user_name_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['user_name_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['user_name_c']['value']; ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['password_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSWORD','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="varchar" field="password_c"    style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['password_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['password_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['password_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['password_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['password_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['password_c']['value']; ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
...
<div class="col-sm-12" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['portal_active_user_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ACTIVE_USER','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
<div class="inlineEdit" type="bool" field="portal_active_user_c"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
<?php if (! $this->_tpl_vars['fields']['portal_active_user_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strval ( $this->_tpl_vars['fields']['portal_active_user_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['portal_active_user_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['portal_active_user_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'CHECKED');  else:  $this->assign('checked', "");  endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['portal_active_user_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['portal_active_user_c']['name']; ?>
" value="$fields.portal_active_user_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</div>
