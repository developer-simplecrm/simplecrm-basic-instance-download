<?php /* Smarty version 2.6.11, created on 2017-09-13 17:43:47
         compiled from cache/modules/Cases/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Cases/EditView.tpl', 38, false),array('modifier', 'default', 'cache/modules/Cases/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Cases/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/Cases/EditView.tpl', 121, false),array('modifier', 'count', 'cache/modules/Cases/EditView.tpl', 201, false),array('function', 'sugar_include', 'cache/modules/Cases/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/Cases/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/Cases/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/Cases/EditView.tpl', 96, false),array('function', 'sugar_getjspath', 'cache/modules/Cases/EditView.tpl', 532, false),)), $this); ?>
...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['source_c']['value'] ) && $this->_tpl_vars['fields']['source_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['source_c']['options'],'selected' => $this->_tpl_vars['fields']['source_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['source_c']['options'],'selected' => $this->_tpl_vars['fields']['source_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['source_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['source_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['source_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['source_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['source_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['source_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['source_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['source_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['contacts_cases_1contacts_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
...
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"contacts_cases_1contacts_ida","name":"contacts_cases_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['contacts_cases_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
addToValidate(\'EditView\', \'feedback_explaination_time_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_EXPLAINATION_TIME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'twitter_handle_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TWITTER_HANDLE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feeback_case_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEBACK_CASE_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'post_from_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_POST_FROM_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'post_from_first_name_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_POST_FROM_FIRST_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'feedback_on_website_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_ON_WEBSITE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feeback_service_rating_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEBACK_SERVICE_RATING','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'escalation_level_2_checkbox_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESCALATION_LEVEL_2_CHECKBOX','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'escalation_level_1_checkbox_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESCALATION_LEVEL_1_CHECKBOX','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_recommend_friend_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_RECOMMEND_FRIEND','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'source_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SOURCE','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'contacts_cases_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTS_CASES_1_FROM_CONTACTS_TITLE','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_description_c\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_DESCRIPTION','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_submitted_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_SUBMITTED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_resolution_time_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_RESOLUTION_TIME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'posted_message_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_POSTED_MESSAGE_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_resolution_result_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_RESOLUTION_RESULT','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feeback_email_sent_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEBACK_EMAIL_SENT','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'facebook_comment_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FACEBOOK_COMMENT_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'escalation_level_3_checkbox_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESCALATION_LEVEL_3_CHECKBOX','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_recommendation_time_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_RECOMMENDATION_TIME','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'tweet_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TWEET_ID','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'closed_status_reply_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CLOSED_STATUS_REPLY','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'add_comment_ids_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADD_COMMENT_IDS','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'feedback_date_entered_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FEEDBACK_DATE_ENTERED','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'post_from_last_name_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_POST_FROM_LAST_NAME','module' => 'Cases','for_js' => true), $this); echo '\' );
