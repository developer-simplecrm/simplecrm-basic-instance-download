<?php /* Smarty version 2.6.11, created on 2017-09-13 17:04:07
         compiled from cache/modules/AOS_Products/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/AOS_Products/DetailView.tpl', 124, false),array('function', 'sugar_translate', 'cache/modules/AOS_Products/DetailView.tpl', 133, false),array('function', 'counter', 'cache/modules/AOS_Products/DetailView.tpl', 138, false),array('function', 'sugar_getimage', 'cache/modules/AOS_Products/DetailView.tpl', 163, false),array('function', 'sugar_ajax_url', 'cache/modules/AOS_Products/DetailView.tpl', 209, false),array('function', 'sugar_number_format', 'cache/modules/AOS_Products/DetailView.tpl', 286, false),array('function', 'sugar_getjspath', 'cache/modules/AOS_Products/DetailView.tpl', 427, false),array('modifier', 'strip_semicolon', 'cache/modules/AOS_Products/DetailView.tpl', 149, false),array('modifier', 'escape', 'cache/modules/AOS_Products/DetailView.tpl', 380, false),array('modifier', 'url2html', 'cache/modules/AOS_Products/DetailView.tpl', 380, false),array('modifier', 'nl2br', 'cache/modules/AOS_Products/DetailView.tpl', 380, false),)), $this); ?>
...
" id="delete_button"><?php endif; ?> </li><li><input type="submit" class="button" name="create" id="create" value="Create Product" onClick="document.location='index.php?module=AOS_Products&action=EditView&return_module=AOS_Products&return_action=DetailView'"/></li><li><?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<li><a id="tab0" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'AOS_Products'), $this);?>
</em></a></li>
</ul>
...
<div class="inlineEdit" type="varchar" field="part_number"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="relate" field="aos_product_category_name"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="id" field="currency_id"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="currency" field="cost"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="currency" field="price"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="relate" field="contact"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="varchar" field="url"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="varchar" field="product_image"  colspan='3'  style="font-size:14px;word-wrap: break-word;">
...
var AOS_Products_detailview_tabs = new YAHOO.widget.TabView("AOS_Products_detailview_tabs");
AOS_Products_detailview_tabs.selectTab(0);
</script>
