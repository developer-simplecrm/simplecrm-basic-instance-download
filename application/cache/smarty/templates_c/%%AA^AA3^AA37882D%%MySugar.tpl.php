<?php /* Smarty version 2.6.11, created on 2017-09-13 21:18:29
         compiled from themes/SuiteR/tpls/MySugar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getscript', 'themes/SuiteR/tpls/MySugar.tpl', 71, false),array('function', 'counter', 'themes/SuiteR/tpls/MySugar.tpl', 128, false),array('function', 'sugar_getjspath', 'themes/SuiteR/tpls/MySugar.tpl', 228, false),)), $this); ?>
<?php echo '
    <style>
        .menu {
            z-index: 100;
...
"><?php echo $this->_tpl_vars['tab']['pageTitle']; ?>
    ...
    <?php if (! $this->_tpl_vars['lock_homepage']): ?>
        ...
        <li class="addButton ">
            <a style='cursor: pointer;border:1px solid #2767A8' class="btn-sm" onclick="addDashboardForm(<?php echo $this->_tpl_vars['tabNum']; ?>
);">
