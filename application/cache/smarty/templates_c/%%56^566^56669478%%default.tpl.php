<?php /* Smarty version 2.6.11, created on 2017-09-13 15:59:18
...
?>
    <div class="alert alert-<?php if ($this->_tpl_vars['result']->type != null):  echo $this->_tpl_vars['result']->type;  else: ?>info<?php endif; ?> alert-dismissible module-alert" role="alert">
...
');"><span aria-hidden="true">&times;</span></button>
        ...
        <a class="alert-link text-<?php if ($this->_tpl_vars['result']->type != null):  echo $this->_tpl_vars['result']->type;  else: ?>info<?php endif; ?>" href="index.php?module=Alerts&action=redirect&record=<?php echo $this->_tpl_vars['result']->id; ?>
">
        <?php endif; ?>
...
s.gif"/>
                <strong class="text-<?php if ($this->_tpl_vars['result']->type != null):  echo $this->_tpl_vars['result']->type;  else: ?>info<?php endif; ?>"><?php echo $this->_tpl_vars['result']->target_module; ?>
</strong>
            <?php else: ?>
                <strong class="text-<?php if ($this->_tpl_vars['result']->type != null):  echo $this->_tpl_vars['result']->type;  else: ?>info<?php endif; ?>">Alert</strong>
            <?php endif; ?>
