<?php /* Smarty version 2.6.11, created on 2017-09-13 17:00:15
         compiled from cache/modules/AOS_Quotes/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/AOS_Quotes/DetailView.tpl', 124, false),array('function', 'sugar_translate', 'cache/modules/AOS_Quotes/DetailView.tpl', 133, false),array('function', 'counter', 'cache/modules/AOS_Quotes/DetailView.tpl', 144, false),array('function', 'sugar_getimage', 'cache/modules/AOS_Quotes/DetailView.tpl', 169, false),array('function', 'sugar_ajax_url', 'cache/modules/AOS_Quotes/DetailView.tpl', 185, false),array('function', 'sugar_number_format', 'cache/modules/AOS_Quotes/DetailView.tpl', 616, false),array('function', 'sugar_getjspath', 'cache/modules/AOS_Quotes/DetailView.tpl', 850, false),array('modifier', 'strip_semicolon', 'cache/modules/AOS_Quotes/DetailView.tpl', 155, false),array('modifier', 'escape', 'cache/modules/AOS_Quotes/DetailView.tpl', 388, false),array('modifier', 'url2html', 'cache/modules/AOS_Quotes/DetailView.tpl', 388, false),array('modifier', 'nl2br', 'cache/modules/AOS_Quotes/DetailView.tpl', 388, false),array('modifier', 'strip_tags', 'cache/modules/AOS_Quotes/DetailView.tpl', 481, false),)), $this); ?>
...
" id="merge_duplicate_button"><?php endif; ?> </li><li><input type="button" class="button" id="print_pdf" onClick="showPopup('pdf');" value="<?php echo $this->_tpl_vars['MOD']['LBL_PRINT_AS_PDF']; ?>
"/></li><li><input type="button" class="button" id="email_pdf" onClick="showPopup('emailpdf');" value="<?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_PDF']; ?>
"/></li><li><input type="button" class="button" id="email_quote" onClick="showPopup('email');" value="<?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_QUOTE']; ?>
"/></li><li><input class="button" id="create_contract_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_OPPORTUNITY']; ?>
...
"/></li><li><input class="button" id="create_contract_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_CONTRACT']; ?>
...
"/></li><li><input class="button" id="convert_to_invoice_button" title="<?php echo $this->_tpl_vars['MOD']['LBL_CONVERT_TO_INVOICE']; ?>
...
"/></li><li><input type="submit" class="button" name="create" id="create" value="Create Quote" onClick="document.location='index.php?module=AOS_Quotes&action=EditView&return_module=AOS_Quotes&return_action=DetailView'"/></li><li><?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
...
<li><a id="tab0" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_OVERVIEW','module' => 'AOS_Quotes'), $this);?>
</em></a></li>

<li><a id="tab1" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QUOTE_TO','module' => 'AOS_Quotes'), $this);?>
</em></a></li>

<li><a id="tab2" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LINE_ITEMS','module' => 'AOS_Quotes'), $this);?>
</em></a></li>

<li><a id="tab3" href="javascript:void(0)"><em ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ASSIGNMENT','module' => 'AOS_Quotes'), $this);?>
</em></a></li>
</ul>
...
<div class="inlineEdit" type="relate" field="opportunity"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="enum" field="stage"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="date" field="expiration"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="enum" field="invoice_status"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="enum" field="term"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="enum" field="approval_status"    style="font-size:14px;word-wrap: break-word;">
...
<div class="inlineEdit" type="text" field="approval_issue"    style="font-size:14px;word-wrap: break-word;">
...
<div id='LBL_QUOTE_TO' class="panelContainer" cellspacing='<?php echo $this->_tpl_vars['gridline']; ?>
' style="background-color:white;" >
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
<?php if ($this->_tpl_vars['panelFieldCount'] == 0): ?>
<script>document.getElementById("LBL_QUOTE_TO").style.display='none';</script>
<?php endif; ?>
...
<div class="col-sm-6" width='50%' scope="col" style="text-align:left;word-wrap: break-word; padding-top:10px;padding-left:5px;padding-bottom:5px;" >
<span style="font-weight:600">
<?php if (! $this->_tpl_vars['fields']['date_entered']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'AOS_Quotes'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</span>
...
var AOS_Quotes_detailview_tabs = new YAHOO.widget.TabView("AOS_Quotes_detailview_tabs");
AOS_Quotes_detailview_tabs.selectTab(0);
</script>
