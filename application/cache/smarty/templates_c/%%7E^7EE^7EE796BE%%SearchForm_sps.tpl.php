<?php /* Smarty version 2.6.11, created on 2017-09-13 15:59:36
         compiled from cache/modules/Meetings/SearchForm_sps.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Meetings/SearchForm_sps.tpl', 30, false),array('function', 'math', 'cache/modules/Meetings/SearchForm_sps.tpl', 31, false),array('function', 'sugar_translate', 'cache/modules/Meetings/SearchForm_sps.tpl', 40, false),array('function', 'html_options', 'cache/modules/Meetings/SearchForm_sps.tpl', 46, false),array('function', 'sugar_getimage', 'cache/modules/Meetings/SearchForm_sps.tpl', 139, false),array('modifier', 'default', 'cache/modules/Meetings/SearchForm_sps.tpl', 147, false),array('modifier', 'count', 'cache/modules/Meetings/SearchForm_sps.tpl', 278, false),)), $this); ?>
...
<?php if (isset ( $_REQUEST['date_modified_basic_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['date_modified_basic_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
" value='<?php if (empty ( $_REQUEST['range_date_modified_basic'] ) && ! empty ( $_REQUEST['date_modified_basic'] )):  echo $_REQUEST['date_modified_basic'];  else:  echo $_REQUEST['range_date_modified_basic'];  endif; ?>' title=''   size="11" style="width:100px !important;">
