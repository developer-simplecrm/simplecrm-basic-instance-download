<?php 
 $GLOBALS["dictionary"]["scrm_Partners"]=array (
  'table' => 'scrm_partners',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partners_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partners_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partners_assigned_user',
    ...
    'scrm_partners_type' => 
    array (
      'name' => 'scrm_partners_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'scrm_partners_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partners_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partners_email_addresses',
      'source' => 'non-db',
