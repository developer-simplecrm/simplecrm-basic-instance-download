...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
  ...
  'LBL_MANAGE_ASTERISK' => 'ASTERISK Configuration',
  ...
  'LBL_ASTERISK_EXPR_DESC' => 'Regular expression to match incoming calls',
  'LBL_ASTERISK_SOAPUSER' => 'Asterisk Soap-User',
  'LBL_ASTERISK_LOG_FILE' => 'Log File Path',
  'LBL_ASTERISK_DIALOUT_CHANNEL' => 'Dialout Channel',
  'LBL_ASTERISK_DIALOUT_CHANNEL_DESC' => 'Regular expression the ### will be replaced with current users extension',
