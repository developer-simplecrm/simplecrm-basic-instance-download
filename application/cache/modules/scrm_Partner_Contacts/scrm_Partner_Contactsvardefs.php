<?php 
 $GLOBALS["dictionary"]["scrm_Partner_Contacts"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partner_contacts_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partner_contacts_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partner_contacts_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partner_contacts_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_partner_contacts_email_addresses',
      'source' => 'non-db',
    ...
    'scrm_partners_scrm_partner_contacts_1_name' => 
    array (
    ...
    'scrm_partners_scrm_partner_contacts_1scrm_partners_ida' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Partner_Contactsportal_active_c',
      'custom_module' => 'scrm_Partner_Contacts',
    ),
    'portal_username_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Portal Username',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'portal_username_c',
      'vname' => 'LBL_PORTAL_USERNAME',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Partner_Contactsportal_username_c',
      'custom_module' => 'scrm_Partner_Contacts',
    ),
    'portal_password_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Portal Password',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Partner_Contactsportal_password_c',
      'custom_module' => 'scrm_Partner_Contacts',
    ),
