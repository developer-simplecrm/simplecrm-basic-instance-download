...
<tr><td><label style="margin-left:20%;margin-top:7%; color:#3A5795 !important;">Leads Keywords </label></td><td><textarea style="width:95% !important;padding:2% !important;" id="facebook_keywords_lead" class="form-control" name="facebook_keywords_lead"><?php echo $sugar_config['facebook_keywords_lead'];?></textarea></td></tr>
<tr><td><label style="margin-left:20%;margin-top:7%; color:#3A5795 !important;">Cases Keywords </label></td><td><textarea style="width:95% !important;padding:2% !important;" id="facebook_keywords_case" class="form-control" name="facebook_keywords_case"><?php echo $sugar_config['facebook_keywords_case'];?></textarea></td></tr>
