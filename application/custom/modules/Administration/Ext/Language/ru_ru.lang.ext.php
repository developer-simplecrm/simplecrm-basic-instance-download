 ...
 */
//$mod_strings = array (
//  'LBL_MANAGE_ASTERISK' => 'ASTERISK �?š�?¾�?½Ñ„�?¸�?³ÑƒÑ€�?°Ñ†�?¸Ñ�',
//  'LBL_ASTERISK' => '�?£Ñ�Ñ‚�?°�?½�?¾�?²�?¸Ñ‚�?µ �?¿�?°Ñ€�?°�?¼�?µÑ‚Ñ€Ñ‹ Ñ��?¾�?µ�?´�?µ�?½�?µ�?½�?¸Ñ� ASTERISK',
//  'LBL_ASTERISK_DESC' => '�?£Ñ�Ñ‚�?°�?½�?¾�?²�?¸Ñ‚�?µ �?½�?°Ñ�Ñ‚Ñ€�?¾�?¹�?º�?¸ �?½�?µ�?¾�?±Ñ…�?¾�?´�?¸�?¼Ñ‹�?µ �?´�?»Ñ� Ñ��?¾�?µ�?´�?¸�?½�?µ�?½�?¸Ñ� Ñ� ASTERISK Ñ��?µÑ€�?²�?µÑ€�?¾�?¼.',
//  'LBL_ASTERISK_TITLE' => 'ASTERISK SugarCRM Connector',
//);

if (!isset($mod_strings)) { $mod_strings = array(); }

$mod_strings['LBL_MANAGE_ASTERISK'] = 'ASTERISK Конфигурация';
$mod_strings['LBL_ASTERISK'] = 'Установите параметры соеденения ASTERISK';
$mod_strings['LBL_ASTERISK_DESC'] = 'Установите настройки необходимые для соединения с ASTERISK сервером.';
