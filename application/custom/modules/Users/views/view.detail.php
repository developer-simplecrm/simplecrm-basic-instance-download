...
class UsersViewDetail extends ViewDetail {
    ...
    function display() {
		...
		$var = "If you are developer of this instance, you should place your download link or instructions to download here so that the user can download the instance version he/she is using.
		
		If you are user of this instance and seeing this message, you should contact your administrator to access the source code.\"";
